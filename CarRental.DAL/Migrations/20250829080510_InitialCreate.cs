    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:booking_status_enum", "unknown,pending,confirmed,completed,cancelled")
                .Annotation("Npgsql:Enum:car_status_enum", "unknown,available,booked,maintenance,out_of_service");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialMileage = table.Column<decimal>(type: "numeric", nullable: false),
                    FinalMileage = table.Column<decimal>(type: "numeric", nullable: false),
